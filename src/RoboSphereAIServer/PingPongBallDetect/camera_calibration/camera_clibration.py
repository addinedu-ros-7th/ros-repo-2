...
if __name__ == '__main__':
    ...
    # python3 camera_clibration.py --dir calibration_checkerboard/ --width 8 --height 6 --square_size 0.029

    # python3 camera_clibration.py --dir calibration_checkerboard/ --width 7 --height 5 --square_size 0.032