        ...
        try:
            ...
            if frame is not None:
                ...
                for result in result[0].boxes:
                    ...
                    robot_z = self.robot_position_z + camera_z
                    ...
                    self.get_logger().info(f"World coordinate: ({world_x}, {world_y}, {world_z})")

                    # 객체 인식 결과 저장 및 비교
                    self.update_coordinates((world_x, world_y, world_z))
